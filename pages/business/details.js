    ...
    return (
        <div className={styles.main}>
            ...
            <div style={{ padding: '100px 7%', }}>
                ...
                <div className={styles.container} style={{ display: 'flex', justifyContent: 'space-evenly', background: 'white', position: 'relative', }}>
                    <div>
                        <div style={{ textAlign: "center", padding: '40px', }}>
                            <h4 style={{ textAlign: "center", color: '#4F0DA3', }}>Fill Business Details</h4>
                    ...
                    <div>
                        <div style={{ textAlign: "left", padding: '40px', }}>
                            <div>
                                <h5>Select Professional Display Image</h5>
                            ...
                            <div style={{ margin: '20px 0', }}>
                                <h5>Select Professional Cover Image</h5>
                ...
                <Link href='/personal/details' style={{ color: 'white', textDecoration: 'none', }}>Switch to Personal</Link>
